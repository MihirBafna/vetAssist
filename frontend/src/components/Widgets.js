...
import world from "../assets/img/illustrations/world.svg";
  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        <Card.Img src={photo} alt="Neil Portrait" className="user-avatar large-avatar rounded-circle mx-auto mt-n7 mb-4" />
            ...
            {['checkbox'].map((type) => (
              <div key={`default-${type}`} className="mb-3">
                <Form.Check 
                  type={type}
                  id={`Medication-${type}`}
                  label={`Medication`} style={{fontSize:"4vh"}}
                />
                <Form.Check 
                  type={type}
                  id={`Daily Survey-${type}`}
                  label={`Daily Survey`}
                  style={{fontSize:"4vh"}}
                />
                <Form.Check 
